        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
          ...
          onSubmit={onSubmit} className='max-w-2xl mx-auto'>
           <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
            ...
            className='flex-1 p-3 outline-none border-[0.5px] border-x-gray-400 rounded-md bg-white dark:bg-darkHover/30 dark:border-white/90' name='name'/>
            ...
            className='flex-1 p-3 outline-none border-[0.5px] border-x-gray-400 rounded-md bg-white dark:bg-darkHover/30 dark:border-white/90' name='email'/>
